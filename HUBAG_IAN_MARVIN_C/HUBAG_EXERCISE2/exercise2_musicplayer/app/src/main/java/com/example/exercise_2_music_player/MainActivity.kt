...
//        2c. Setup the Song title using substringBefore to get only the name (before " - ")
...
//        3a. Moved ExoPlayer initialization to onStart()
...
//        2e. Complete the addListener function to update the TextView with player state
    ...
    //    3c. Play the music when the activity is resumed
